...
* [066efe5](https://github.com/mturley/uxd-exercises/commit/066efe573f5bce1f518796aeb38906805c832b47): I decided to install [eslint](https://eslint.org/) and use it to enforce the [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) because I was a bit frustrated with the lack of consistent style in the redux-minimal template. I might have to send them a PR or two!
